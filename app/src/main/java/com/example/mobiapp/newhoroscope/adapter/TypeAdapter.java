...
public class TypeAdapter extends RecyclerView.Adapter<TypeAdapter.ViewHolder> {
    ...
    public TypeAdapter(HoroActivity activity, List<ItemHoro> list) {
    ...
    public TypeAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new TypeAdapter.ViewHolder(v);
    }


    public void onBindViewHolder(final TypeAdapter.ViewHolder holder, final int position) {
    ...
    private void resetAllCheck(int position) {
        ...
        activity.setType(list.get(position).getName_eng());
    }
