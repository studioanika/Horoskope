...
public class SpaceNavigationView extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            centreButtonIcon = typedArray.getResourceId(R.styleable.SpaceNavigationView_centre_button_icon, R.drawable.ic_dehaze_black_24dp);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (centreButtonIcon == NOT_DEFINED)
            centreButtonIcon = R.drawable.ic_dehaze_black_24dp;
    ...
    public void rotateButton(){
        if(isRotate){
            isRotate = false;
            try {
                centreButton.animate().rotation(0);
            }catch (Exception e){}
        }
    }
                ...
                if (spaceOnClickListener != null) {
                    ...
                    if(!isRotate){
                        isRotate = true;
                            ...
                            centreButton.animate().rotation(90);
...
//                    updateSpaceItems(-1);
     ...
     */
    private void updateSpaceItems(int selectedIndex) {
         ...
         */
        if (spaceOnClickListener != null && selectedIndex >= 0 && selectedIndex!=5)
